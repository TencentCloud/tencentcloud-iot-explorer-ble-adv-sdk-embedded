 ...
 *
 */
#ifndef TENCENTCLOUD_IOT_EXPLORER_BLE_ADV_SDK_EMBEDDED_SDK_INTERNAL_INC_BLE_QIOT_LOG_H_
#define TENCENTCLOUD_IOT_EXPLORER_BLE_ADV_SDK_EMBEDDED_SDK_INTERNAL_INC_BLE_QIOT_LOG_H_
...
#define ble_qiot_log_d(fmt, args...)                                       \
    do {                                                                   \
        if (g_log_level < BLE_QIOT_LOG_LEVEL_DEBUG)                        \
            break;                                                         \
        LLSYNC_ADV_LOG_PRINT("qiot debug: " fmt LOG_LINE_FEED_TYPE, ##args); \
    } while (0)
#endif
...
#define ble_qiot_log_i(fmt, args...)                                      \
    do {                                                                  \
        if (g_log_level < BLE_QIOT_LOG_LEVEL_INFO)                        \
            break;                                                        \
        LLSYNC_ADV_LOG_PRINT("qiot info: " fmt LOG_LINE_FEED_TYPE, ##args); \
    } while (0)
#endif
...
#define ble_qiot_log_w(fmt, args...)                                                                 \
    do {                                                                                             \
        if (g_log_level < BLE_QIOT_LOG_LEVEL_WARN)                                                   \
            break;                                                                                   \
        LLSYNC_ADV_LOG_PRINT("qiot warn(%s|%d): " fmt LOG_LINE_FEED_TYPE, __FILE__, __LINE__, ##args); \
    } while (0)
#endif
...
#define ble_qiot_log_e(fmt, args...)                                                                \
    do {                                                                                            \
        if (g_log_level < BLE_QIOT_LOG_LEVEL_ERR)                                                   \
            break;                                                                                  \
        LLSYNC_ADV_LOG_PRINT("qiot err(%s|%d): " fmt LOG_LINE_FEED_TYPE, __FILE__, __LINE__, ##args); \
    } while (0)
#endif
...
#define ble_qiot_log(level, fmt, args...)                                                           \
    do {                                                                                            \
        if (g_log_level < level)                                                                    \
            break;                                                                                  \
        LLSYNC_ADV_LOG_PRINT("qiot log(%s|%d): " fmt LOG_LINE_FEED_TYPE, __FILE__, __LINE__, ##args); \
    } while (0)
#endif
...
#endif
#endif  // TENCENTCLOUD_IOT_EXPLORER_BLE_ADV_SDK_EMBEDDED_SDK_INTERNAL_INC_BLE_QIOT_LOG_H_
